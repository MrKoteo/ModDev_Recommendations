...
Я не буду опускаться до низкоуровневых нюансов, пройдусь лишь по "базе".
Оптимизации кода могут быть разные:
- Сокращение лишних проверок, рефлексий, сокращение излишней логики (если она не необходима) и преобразований.
- Использование оптимальных типов данных и конструкций (в т.ч. оптимальная работа с памятью)
- Использование минималистичных элементов по возможности:  операторы вместо методов, примитивы вместо объектов,
- Организация структуры кода для минимизации выполняемого кода в рантайме*
- Минимизация операций работы с диском
- Минимизация логирования
- Можно кешировать данные, которые часто используются в рантайме
- Минимизация отправляемых сетевых пакетов
- Использовать статические методы и final константы, если они не должны изменяться в процессе.


* - подразумевает Сокращение выполнения кода, если его невыполнение в итерации ни на что не повлияет. Например, если можно проверить условие сразу при вызове метода, зачем выполнять ещё половину метода, если условие False ?
